...
func (_Contracts *ContractsCaller) Minter(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Contracts.contract.Call(opts, &out, "minter")
...
//
// Solidity: function minter() view returns(address)
func (_Contracts *ContractsSession) Minter() (common.Address, error) {
	return _Contracts.Contract.Minter(&_Contracts.CallOpts)
}

// Minter is a free data retrieval call binding the contract method 0x07546172.
//
// Solidity: function minter() view returns(address)
func (_Contracts *ContractsCallerSession) Minter() (common.Address, error) {
	return _Contracts.Contract.Minter(&_Contracts.CallOpts)
}
